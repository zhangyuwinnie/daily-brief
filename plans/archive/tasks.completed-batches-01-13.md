# Archived Tasks: Completed MVP Batches 01-13

Archived from the active `tasks.md` on 2026-04-10 before switching the active task
surface to the automation workstream.
